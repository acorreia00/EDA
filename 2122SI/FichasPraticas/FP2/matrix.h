...
class Matrix {
	...
	private:
	    ...
	    // Funções privadas
		void Delete();
		// Apagar a memória dinâmica criada para a matriz
		void Create(int lines, int cols);
		// Criar a memória dinâmica e inicializar a matriz
	...
	public:
	  ...
	  // Soma cada elemento da matriz com o valor k
	  const Matrix& operator *= (int k);
	  // Multiplica cada elemento da matriz por k
